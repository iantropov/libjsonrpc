...
#define EVHTTP_CON_CLOSEDETECT  0x0004  /* detecting if persistent close */
	...
	SSL *ssl;
	struct event ssl_event;

	struct event defer_read_ev;
	struct timeval defer_time;

	void (*read)(int, short, void *);
	void (*write)(int, short, void *);
};
...
struct evhttp {
	...
	SSL_CTX *ctx;
	void (*get_request)(struct evhttp *http, int fd, struct sockaddr *sa, socklen_t salen);
};
